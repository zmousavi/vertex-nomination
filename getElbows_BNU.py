...
# @references, Zhu, Mu and Ghodsi, Ali (2006), Automatic dimensionality selection from the scree plot via the use of profile likelihood, Computational Statistics & Data Analysis, Volume 51 Issue 2, pp 918-930, November, 2006

import numpy as np
from scipy.stats import norm

def getElbows(L, n_elbows = 1, threshold = 0):
    """
